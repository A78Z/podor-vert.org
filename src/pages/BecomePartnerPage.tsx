...
const BecomePartnerPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const partner = new Parse.Object('Partner');
      partner.set('name', formData.name);
      partner.set('email', formData.email);
      partner.set('phone', formData.phone);
      partner.set('company', formData.company);
      partner.set('partner_type', formData.partnerType);
      partner.set('message', formData.message);
      partner.set('status', 'en_attente'); // Default status
