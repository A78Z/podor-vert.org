...
export const newsList: NewsArticle[] = [
    {
        id: 10,
        image: "/images/news/blues-du-fleuve-2025-v2.jpg",
        date: "08 décembre 2025",
        title: "Podor Vert au cœur du Festival Les Blues du Fleuve 2025",
        description: "Un week-end intense pour célébrer cinq années d'impact, entre engagement citoyen et développement durable, dans un cadre symbolique.",
        link: "/actualites/10",
        fullContent: [], // Content is handled by custom page
    },
    {
        id: 1,
