...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-72 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-40 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
          } lg:translate-x-0`}
      >
