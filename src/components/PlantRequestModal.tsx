...
export default function PlantRequestModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const plantRequest = new Parse.Object('PlantRequest');
      plantRequest.set('organization_name', formData.organizationName);
      plantRequest.set('groupment_type', formData.groupmentType);
      plantRequest.set('responsible_name', formData.responsibleName);
      plantRequest.set('email', formData.email);
      plantRequest.set('phone', formData.phone);
      plantRequest.set('location', formData.location);
      plantRequest.set('planned_date', formData.plannedDate);
      plantRequest.set('quantity_requested', parseInt(formData.quantityRequested));
      plantRequest.set('plant_species', formData.plantSpecies);
      plantRequest.set('activity_objective', formData.activityObjective);
      plantRequest.set('additional_message', formData.additionalMessage || null);
      plantRequest.set('status', 'nouveau');
